...
--download_to_file('https://raw.githubusercontent.com/fandam2/fandam/master/Script.lua','Script.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/fandam2/File_fandam/master/getfile.json")
if res == 200 then
